...
A digital botanical garden built with *SvelteKit* and *TypeScript*, consuming the [Hapi.js based backend API](https://github.com/johannesroesner/leaf-library-backend).
