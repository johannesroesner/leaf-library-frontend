...
<fieldset class="fieldset w-xs rounded-box border border-base-300 bg-base-200 p-4">
  ...
  {#if allFieldsFilled && !isPasswordLengthValid}
    <p class="mt-2 text-center text-xs text-error">Passwords min length is 8</p>
  {/if}
  ...
  <p class="mt-4 text-center text-sm text-base-content/70">
    ...
    <a href="/login" class="link font-semibold text-primary link-hover"> Login </a>
  </p>
  ...
  <div class="flex w-full items-center justify-center">
    <a
      ...
      href="/"
      class="mt-4 link text-center text-sm font-semibold text-base-content/70 link-hover"
    >
      <svg
